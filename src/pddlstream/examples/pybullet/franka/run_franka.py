...
from examples.pybullet.franka.post_process import post_process
from examples.pybullet.utils.pybullet_tools.utils import draw_base_limits, WorldSaver, has_gui, str_from_object

from examples.pybullet.franka.problems_franka import PROBLEMS

# ROS wrapper
import rospy
from examples.pybullet.franka.ros_commander import ROS_Commander
...
def main(verbose=True):
    ...
    parser.add_argument('-t', '--max_time', default=50, type=int, help='The max time')
