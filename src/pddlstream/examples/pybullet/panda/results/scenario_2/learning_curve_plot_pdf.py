...
plt.savefig("el_s2.pdf", bbox_inches="tight")
plt.show()
...
# plt.suptitle(titlename, fontsize=fontsize)
plt.savefig("er_s2.pdf", bbox_inches="tight")
plt.show()
...
# plt.suptitle(titlename, fontsize=fontsize)
plt.savefig("ia_s2.pdf", bbox_inches="tight")
plt.show()
...
# plt.suptitle(titlename, fontsize=fontsize)
plt.savefig("sr_s2.pdf", bbox_inches="tight")
plt.show()
