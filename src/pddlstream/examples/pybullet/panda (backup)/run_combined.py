...
# Push
from examples.pybullet.panda.pushing import pushes, scenario, camera
...
def main(verbose=True):
    ...
    with HideOutput():
        ...
        problem = problem_fn(num=args.number, obj_poses=obj_poses, robot=robot) 
